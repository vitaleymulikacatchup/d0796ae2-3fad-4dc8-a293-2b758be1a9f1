...
export const metadata: Metadata = {
  title: "SurfClub Haifa - Ride the Waves",
  description: "Join SurfClub Haifa for exciting surf lessons and ocean adventures.",
  keywords: "surfing, Haifa, surf lessons, ocean, adventure",
  openGraph: {
    title: "SurfClub Haifa - Ride the Waves",
    description: "Join SurfClub Haifa for exciting surf lessons and ocean adventures.",
    siteName: "SurfClub Haifa",
    images: [{ url: "https://images.pexels.com/photos/34286743/pexels-photo-34286743.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "SurfClub Haifa - Ride the Waves",
    description: "Join SurfClub Haifa for exciting surf lessons and ocean adventures.",
    images: ["https://images.pexels.com/photos/34286743/pexels-photo-34286743.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: "index, follow",
};
